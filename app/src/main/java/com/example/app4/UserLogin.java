...
import com.example.app4.admin_files.AdminHomePage;
...
//            Toast.makeText(UserLogin.this, "Logged In Successfully", Toast.LENGTH_SHORT).show();
        ...
        b1.setOnClickListener(v -> {
            if (phnno.getText().toString().equals("9307780296")){
                x = HomePage.class;
            } else if (phnno.getText().toString().equals("8356871272")) {
                x = AdminHomePage.class;
            } else {
...
//                        e.commit();
                                ...
                                startActivity(new Intent(UserLogin.this, x));
                                Log.v("User", "Logged In Successfully");
